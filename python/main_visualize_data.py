...
if __name__ == "__main__":
    ...
    os.makedirs('../plots/%s' % args.scenario_name, exist_ok=True)
    plt.savefig('../plots/%s/%s' % (args.scenario_name, track_file_prefix + str(args.track_file_number).zfill(3)))
    plt.show()
